...
<div class="container" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; padding: 30px; margin: 50px auto; background: #fff; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); max-width: 900px;">
    <div style="padding: 20px; display: flex; align-items: center; justify-content: center;">
        <img src="https://img.freepik.com/free-vector/checklist-concept-illustration_114360-339.jpg?t=st=1732622236~exp=1732625836~hmac=7ddd75b9bf2c64d4e0101bfce5470c5d2c2648ed27b2607f827c7471d347df59&w=996"
    ...
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 20px;">
        ...
        %>
        <% if (message != null) { %>
        <p style="color: red; font-size: 1rem; margin-bottom: 15px;">
            <%= message %>
        </p>
        <% } else { %>
        <p style="color: red; font-size: 1rem; margin-bottom: 15px;">
        ...
        <h2 style="color: #007bff; margin-bottom: 20px;">Login</h2>
        <form action="LoginServlet" method="post" style="display: flex; flex-direction: column; gap: 15px; width: 100%; max-width: 300px;">
            <input type="text" name="username" placeholder="Enter username" required
                   style="padding: 12px; border: 1px solid #ccc; border-radius: 5px; font-size: 1rem; width: 100%;">
    ...
    "
        ...
        <div class="message" style="margin-top: 15px; font-size: 0.9rem;">
            Don't have an account? <a href="signup.jsp" style="color: #007bff; text-decoration: none;">Sign Up</a>
        </div>
    </div>
</div>
